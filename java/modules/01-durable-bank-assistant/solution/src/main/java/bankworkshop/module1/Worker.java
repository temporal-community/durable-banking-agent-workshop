...
public final class Worker {
  ...
  public static final String TASK_QUEUE = "durable-bank-assistant-tq-java";
  static final String TARGET =
      System.getenv().getOrDefault("TEMPORAL_ADDRESS", "127.0.0.1:7233");
  ...
  public static void main(String[] args) {
    ...
    worker.registerActivitiesImplementations(new BankAssistantActivitiesImpl());
    factory.start();
