...
/** Same-origin API + frontend. POST /transfer starts the workflow and returns immediately;
 * GET /transfer/{id} polls status. */
public final class ApiMain {
    ...
    public static void main(String[] args) {
        ...
        }).start(Integer.parseInt(System.getenv().getOrDefault("PORT", "8000")));
    }
